...
public class GUIPanel extends JPanel {
    ...
    public void setDetails(EidInfo info) {
        ...
        personalNumber.setText(info.get(Tag.PERSONAL_NUMBER));
        dateOfBirth.setText(info.get(Tag.DATE_OF_BIRTH));
        ...
        docRegNo.setText(info.get(Tag.DOC_REG_NO));
        issuingDate.setText(info.get(Tag.ISSUING_DATE));
        expiryDate.setText(info.get(Tag.EXPIRY_DATE));
        issuingAuthority.setText(info.get(Tag.ISSUING_AUTHORITY));
    }
